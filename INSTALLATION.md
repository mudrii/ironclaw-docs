...
> Version: v0.25.0 | Tested on: macOS 15 (Apple Silicon), macOS 14 (Intel), Linux
...
```bash
ironclaw --version
# Expected for this docs baseline: ironclaw 0.25.0
```
...
*Source: IronClaw v0.25.0 · See also: [ARCHITECTURE.md](ARCHITECTURE.md), [AGENT_README.md](AGENT_README.md)*
