...
**Tech Stack:** Rust (`src/`), Markdown docs (`docs/`), GitHub releases
...
**Files:**
- Read: `README.md` (docs index)
- Read: `AGENT_README.md` (agent reference)
- Read source: `src/main.rs`, `src/cli/mod.rs` (from the `ironclaw` checkout)
...
- Read source: `src/bootstrap.rs`, `src/config/database.rs`, `src/db/tls.rs`, `src/tunnel/` (from the `ironclaw` checkout)
...
**Files:**
- Read: `SIGNAL_SETUP.md`
- Read source: `src/channels/signal.rs` (from the `ironclaw` checkout)
...
- Read source: Telegram channel code under `src/channels/telegram/` (from the `ironclaw` checkout)
...
- Read source: `src/tools/`, `src/agent/scheduler.rs`, `src/agent/routine.rs` (from the `ironclaw` checkout)
...
**Files:**
- Read: `BUILDING_CHANNELS.md`
- Read source: `src/extensions/`, `src/channels/` (from the `ironclaw` checkout)
...
**Files:**
- Read: `LLM_PROVIDERS.md`
- Read source: `src/config/llm.rs`, `src/llm/` (from the `ironclaw` checkout)
...
- Read source: `src/cli/tool.rs`, `src/setup/` (from the `ironclaw` checkout)
...
**Files:**
- Read: `analysis/tools.md`
- Read: `analysis/skills-extensions.md`
- Read: `analysis/worker-orchestrator.md`
- Read: `analysis/secrets-keychain.md`
- Read: `analysis/tunnels-pairing.md`
- Read: `analysis/channels.md`
- Read: `analysis/config.md`
